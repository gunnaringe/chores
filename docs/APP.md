# Chores — detailed reference

This is the detail that doesn't fit in `README.md`'s quick pitch: how each
part of the app actually behaves, hosting, authentication, and the
operational procedures (schema migrations, regenerating generated code,
CI). If you're just trying to run the app, `README.md`'s Quick Start is
enough — come here for anything more specific.
...
To self-host, clone this repo and run:
