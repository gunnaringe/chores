...
const TRANSLATIONS = {
  en: {
    ...
    "login.hosting": "Runs on Fly.io in Stockholm, behind CloudFront for DNS, with login handled by Auth0. Data lives in a SQLite database.",
  ...
  nb: {
    ...
    "login.hosting": "Kjører på Fly.io i Stockholm, bak CloudFront for DNS, med innlogging via Auth0. Dataene ligger i en SQLite-database.",
